...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/streamlit-aggrid-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/streamlit-aggrid-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add streamlit-aggrid
# for installing globally
pixi global install streamlit-aggrid
```
...
It is possible to list all of the versions of `streamlit-aggrid` available on your platform:
...
```
pixi search streamlit-aggrid --channel conda-forge
```
